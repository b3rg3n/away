...
screen aw_r1_all_scr:
    ...
    modal True
    imagemap: 
        ground "away/img/scr/aw_r1_h_all_n.webp" 
        hover "away/img/scr/aw_r1_h_all_y.webp" 
        alpha True
...
screen aw_r1_f_all_scr:
    ...
    modal True
    imagemap: 
        ground "away/img/scr/aw_r1_f_h_all_n.webp" 
        hover "away/img/scr/aw_r1_f_h_all_y.webp" 
        alpha True
        hotspot (753, 846, 106, 133) clicked[Jump("aw_r1_buk_chek")]
        hotspot (854, 717, 75, 39) clicked[Jump("aw_r1_b1_chek")]
        hotspot (868, 808, 73, 42) clicked[Jump("aw_r1_b2_chek")]
...
screen aw_r1_pclogin:
    ...
    modal True
    imagemap: 
        ground "away/img/scr/aw_r1_pc_hn.webp" 
        hover "away/img/scr/aw_r1_pc_hy.webp" 
        alpha True
        hotspot (772, 686, 394, 48) clicked[Jump("aw_r1_pc_code_bergen")]
        hotspot (1553, 931, 98, 47) clicked[Jump("aw_r1_cheker")]

label aw_r1_pc_code_bergen:
    $ renpy.block_rollback()
...
screen aw_r1_pclogin_err:
    ...
    modal True
    imagemap: 
        ground "away/img/scr/aw_r1_pc2_hn.webp" 
        hover "away/img/scr/aw_r1_pc2_hy.webp" 
        alpha True
...
screen aw_r1_pclogin_er:
    ...
    imagemap: 
        ground "away/img/scr/aw_r1_pc_hn.webp" 
        hover "away/img/scr/aw_r1_pc_hn.webp" 
        alpha True
        hotspot (772, 686, 394, 48) clicked[Jump("aw_r1_pc_code")]
        hotspot (1553, 931, 98, 47) clicked[Jump("aw_r1_cheker")]
...
screen aw_r1_lock_hack_s:
    ...
    modal True
    imagemap: 
        ground "away/img/parts/codelock/aw_code_lock_h_n.webp" 
        hover  "away/img/parts/codelock/aw_code_lock_h_y.webp" 
        alpha True
