...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("История") action Start()
        ...
        textbutton _("Прочь") action Quit(confirm=not main_menu)


# AW_CFG

screen navigation_aw():

    vbox:
        style_prefix "navigation_aw"
