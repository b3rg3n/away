...
define config.main_menu_music = "away/snd/mp3/aw_foolow_the_reditus.mp3"
...
define config.enter_transition = awrain2
define config.exit_transition = awrain


## Переход между экранами игрового меню.

define config.intra_transition = blinds


## Переход, используемый после загрузки слота сохранения.

define config.after_load_transition = awnoose
...
define config.save_directory = "AWAY"
...
define config.window_icon = "gui/aw_icon.png"
